class VentCalculator:
    ...
    def claclulate(self, v_box, f_box,):
        ...
        self.__display.print(
            "Total vent diameter (considers number of vents) [cm]: ")
        ...
        self.__display.print(
            "Total x max (considers number of speakers) [cm]: ")
        self.__display.println(str(total_x_max))

        # Convert SD to mm2 and multiply by number of speeakers
        ...
        if (total_minimum_vent_diamater >= total_vent_diameter):
            self.__display.println(
                "ERROR: Total vent diameter is lesser that minimum vent diamater!")
        self.__display.println(
            "-----------------------------------------------------------")
