...
try:
    ...
    print("**********************************")
    print("**********************************")
    print("Missing python packages that are required to run this BoxCalc.")
    print("Use pip install <module>")
    print("For python 3.11 it shall be enough to install:")
    print("pip install Image")
    print("Other used modules are: tk(tkinter), pickle, math, datetime, ImageTk")
    print("**********************************")
    print("**********************************")
    print("**********************************")    
...
class MainWindow(Frame):
    ...
    def create_widgets(self):
        ...
        self.__text_display.println(
            "The 2 speakers configuration is: parallel with a common cavity.")
        self.__text_display.println(
            "Filters configuration for the 2 speakers can be parallel or cascade.")
        self.__text_display.println(
            "Vented Box calculations consider the impact of the filter Rs on the final Qts.")
        self.__text_display.println(
            "Calculations are based on a document published by Jaroslaw Sobolski under the link:")
        self.__text_display.println(
            "https://diyaudio.pl/articles/artyku-y/638981-obudowa-bass-reflex")
        self.__text_display.println(
            "And document publish by Troels Gravesen, under the link:")
        self.__text_display.println(
            "http://www.troelsgravesen.dk/vent_tuning.htm")
        self.__text_display.println(
            "Progam code copyrights belong to T.Jakobiec 2021-2023")
        self.__text_display.println(
        ...
        self.__text_display.println(
            "1. Go to Program -> Speaker Parameters to set up a speaker and filter configuration.")
        self.__text_display.println(
    ...
    def on_display_speaker_parameters(self):
        ...
        speakerWindow = SpeakerWindow.SpeakerWindow(self, self.__speaker_configuration)
        
        self.__speaker_configuration = speakerWindow.GetSpeakerConfiguration()
